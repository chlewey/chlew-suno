...
\tag*{2024}\tag{salsa}\tag{ricochets}\tag{miguel-morocho}\tag{spanish-lyrics}

\begin{notes}
Based on characters from \emph{Ricochets} by Carlos Thompson.\\
Character: Miguel Morocho.\\
Co-written with ChatGPT based on the arc in the novel, the companion texts, and further input by the author.
\end{notes}
