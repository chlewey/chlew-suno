...
\input{gabisson/twenty_twelve_scripts}
\input{gabisson/twenty_thirteen_scripts}
\input{gabisson/twenty_fourteen_scripts}
\input{gabisson/twenty_fifteen_scripts}
\end{multicols*}
...
\emph{The Wrong Map} sets the tone: a mind that keeps redrawing its own directions, craving novelty it can't sustain, faulting its own character before anyone else gets the chance to.
\clearpage\begin{multicols*}{4}
...
\chapter{Recap}
\albumcover{covers/internal/recap}
Old wounds revisited with clearer eyes: a 1988 hatred that no longer bites, and an adolescent rejection finally released from blame.
\clearpage\begin{multicols*}{4}
\input{dvigitt/used_to_say}
\input{dvigitt/buscando_culpables}
\input{chlewey/kvar_i_mig}
\end{multicols*}
...
\input{chlewey/actual_and_relevant}
\end{multicols*}
...
\input{gabisson/let_the_border_breathe_again}
\input{gabisson/no_me_vendas_dolor_de_patria}
\input{wyomee/burden_of_proof}
\input{wyomee/the_question_left_between_us}
\input{dvigitt/hold_the_line}
\input{dvigitt/pass_the_bread}
\end{multicols*}
...
\input{wyomee/between_us}
\input{dvigitt/five_rooms_one_key}
\input{dvigitt/what_remains_where_we_are}
\end{multicols*}
...
\input{chlewey/min_enda_rost}
\input{rataflechera/si_pienso_remastered}
\end{multicols*}
...
\input{gabisson/not_a_label_not_a_part}
\end{multicols*}
...
\input{temp/frisson}
\input{dvigitt/aa_finne_noen_andre_aa_bebreide}
\input{dvigitt/manifest_fault}
\input{wyomee/between_worlds}
\input{gabisson/manet_id}
\input{chlewey/that_hug}
\input{chlewey/sane_mirando_tus_ojos}
\end{multicols*}
