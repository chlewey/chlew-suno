...
\tag*{1991}\tag{electronic-dubstep}\tag{original-source}\tag{despertar-1991}\tag{spanish-lyrics}

\begin{notes}
Based on the original \emph{Despertar} poem by Carlos Thompson, adapted to song structure in 2026 with help of Gemini.
\end{notes}
\begin{style}
