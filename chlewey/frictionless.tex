...
\tag*{2026}\tag{indie-folk}\tag{ai-based}
\begin{notes}
Written with ChatGPT, based on several conversations between Carlos Thompson and ChatGPT.
\end{notes}
\begin{style}
introspective indie-folk, alternative folk-pop, accusation lead vocal, bass baritone, close-mic velvet tone, spoken flow, fast-paced delivery, lo-fi acoustic guitar, fingerpicked verse, brushed snare, subtle glitch edits, tape saturation, plate reverb, instrumental bridges, dynamic build, stripped verse, lifted final chorus, bittersweet longing, self-assertion
\end{style}
\begin{lyrics}
\songpart{Verse 1}
