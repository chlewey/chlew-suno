...
\section{Retrogrades}
\tag{2023}\tag{social-media-post}\tag{country}
...
\tag{2024}\tag{social-media-post}\tag{techno}
...
\tag{thomas-entourage}\tag{aurora-swansen}\tag{r\&b}
...
\tag{ricochets}\tag{fabian-muller}\tag{sandra-roa}\tag{r\&b}
...
\tag{thomas-entourage}\tag{sylvia-lai}\tag{campidanese-pop}
...
\tag{encounters}\tag{ulla}\tag{ia-girlfriend}\tag{r\&b}\tag{electro-pop}
