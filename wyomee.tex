...
Lyrics writen by Gemini on a prompt by the author. %
Low interaction.
\end{notes}
...
\songtitle{The Motion and the Spark}
...
\tag{african-empire}\tag{gladiel}\tag{musical-theater}
...
\tag{encounters}\tag{uneekwa}\tag{esperanto-lyrics}\tag{folk}
...
\tag{ai-generated}\tag{orchestral}\tag{epic}
...
\tag{thomas-entourage}\tag{mariain-schumer}\tag{original-lyrics}\tag{dubstep}
...
\tag{ricochets}\tag{carolina-muller}\tag{ebm-tech}\tag{german-lyrics}
...
Bright, विशाल, and sermon-like in the mix, with close-mic lead and wide, thunderous lows., dubstep, world, contemporary, theme
\end{style}
...
\end{notes}
\begin{style}
Dubstep hymn with halftime wobble bass, stomping kick-snare, and tense syncopated synth pulses; verses stay sparse with close-mic male vocal and clipped doubles, pre-chorus opens into stacked harmony lifts, chorus drops into a wide sub-heavy chant with vowel hooks\annotation{Use} reversed swells, glitch ticks, and filtered risers between lines; final chorus adds choir-like gang layers and a last bass surge\annotation{Bright,} punchy mix with a cold spacious center., hard rock, glam metal, lyrical, dubstep.\\
...
\end{notes}
\begin{style}
Fantasy ballad with intimate male vocals, slow swaying 6/8 feel, fingerpicked acoustic lute and soft frame drum; verse stays sparse and story-led, pre-chorus opens with rising strings and breathy doubles, chorus blooms with layered harmony on the hook phrase\annotation{Add} a low bowed drone, page-turn foley, and a warm harp glint before the last line\annotation{Mix} is wide, antique, and candlelit, world, ballad, deep, warm
\end{style}
\begin{lyrics}
\songpart{Verse 1}
...
\end{notes}
\begin{style}
Medieval epic ballad with slow triple-meter pulse, frame drum and bowed harp under low drone; verse rides sparse lute and solitary voice, pre-chorus opens with hand drum and higher fiddle, chorus swells with a small choir, hammered dulcimer, and open fifths\annotation{Lead} vocal is close-mic and grave with doubled chant on key lines, low male harmonies on the hook, and half-whispered prophecy accents\annotation{Wind} chimes, reversed cymbal swells, and distant horn calls bridge sections; mix is wide, dark, and cinematic with a cold stone-room resonance., reading, light, medieval, ballad, rock, world
\end{style}
\begin{lyrics}
\songpart{Verse 1}
...
\end{notes}
\begin{style}
Epic pop ballad with medieval color, mid-tempo 6/8 sway and driving quarter-note percussion; verse rides lute, harp arpeggios, and low bass, pre-chorus strips to voice, fiddle, and hand drums, chorus opens with full percussion, flute lines, and soaring stacked harmonies\annotation{Lead} vocal stays close and urgent in verses with doubles on key phrases, then widens into chant-like gang harmonies on the hook\annotation{Use} rising swells, reverse cymbal breaths, and a ringing bell hit into each chorus\annotation{Mix} is wide, cinematic, and bright with a polished emotional sheen., harp, medieval, low, tropical, pop, jungle, flat, ballad, world
\end{style}
\begin{lyrics}
\songpart{Verse 1}
