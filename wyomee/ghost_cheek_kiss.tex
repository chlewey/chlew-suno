...
\tag*{2025}\tag{sophisti-pop}\tag{drift}\tag{fran}\tag{original-work}

\begin{notes}
Lyrics co-written with Grok, based on character \textbf{Fran} from the short story \emph{Drift} by Carlos Thompson and ChatGPT.
\end{notes}
