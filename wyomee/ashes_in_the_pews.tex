...
\tag*{2026}\tag{dubstep}\tag{quora-posting}

\begin{notes}
Lyrics by SUNO based on a Quora answer by Carlos Thompson.
\end{notes}
...
Bright, vast, and cathedral-wide, theme, gospel, world, worship, magical, dubstep
\end{style}
