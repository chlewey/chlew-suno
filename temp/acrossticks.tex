...
\tag*{2010}\tag{eurodance}\tag{original-lyrics}\tag{enwigh-peady}\tag{spanish-lyrics}
\begin{notes}
Original acrostic poem by Carlos Thompson, written under the \emph{Enwigh Peady} persona.
\end{notes}
\begin{style}
